/*
 * Magic Powder - 1  [670D1]
 * Problem:  https://codeforces.com/problemset/problem/670/D1
 * Verdict:  ACCEPTED        Solved: 2021-07-13
 * Language: GNU C++11
 * Runtime:  31 ms     Memory: 3800 KB
 * Tags:     binary search, brute force, implementation
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/670/submission/122381118
 */
...
int main()
{
	...
	for(auto&i:a)cin>>i;
	for(auto&i:b)cin>>i;
	uint64_t lo=0,hi=2000000000,ans=hi;
	while(lo<=hi){
