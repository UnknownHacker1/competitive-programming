/*
 * Zmei Gorynich  [1217B]
 * Problem:  https://codeforces.com/problemset/problem/1217/B
 * Verdict:  ACCEPTED        Solved: 2021-07-21
 * Language: C++17 (GCC 9-64)
 * Runtime:  31 ms     Memory: 4200 KB
 * Tags:     greedy, math
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/1217/submission/123188207
 */
...
tc{
	...
	ll mxd=0,mxdiff=-1e9;
	for(int i = 0; i < n; i++)
		cin>>d[i]>>h[i],mxd=max(mxd,d[i]),mxdiff=max(mxdiff,d[i]-h[i]);
	if(x<=mxd){
		cout<<"1\n";
		continue;
	}
