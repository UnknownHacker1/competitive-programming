/*
 * Ehab and Prefix MEXs  [1364C]
 * Problem:  https://codeforces.com/problemset/problem/1364/C
 * Verdict:  ACCEPTED        Solved: 2021-07-29
 * Language: C++17 (GCC 9-64)
 * Runtime:  389 ms     Memory: 56100 KB
 * Tags:     brute force, constructive algorithms, greedy
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/1364/submission/124118952
 */
...
int main()
{
	...
	for(int i = 0; i < n; i++){
		if(st.find(ans[i])!=st.end())st.erase(st.find(ans[i]));
		if(a[i]!=*st.begin()){
			cout<<-1;
			return 0;
		}
