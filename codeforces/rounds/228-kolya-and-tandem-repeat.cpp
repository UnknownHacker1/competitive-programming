/*
 * Kolya and Tandem Repeat  [443B]
 * Problem:  https://codeforces.com/problemset/problem/443/B
 * Verdict:  ACCEPTED        Solved: 2021-06-29
 * Language: C++17 (GCC 7-32)
 * Runtime:  31 ms     Memory: 200 KB
 * Tags:     brute force, implementation, strings
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/443/submission/120908938
 */
...
int main()
{
    ...
    for(int i = 0; i < n; i++){
    	for(int j = i; j < n; j++){
    		if((j-i+1)&1)continue;
    		if(istandemrepeat(string(s.begin()+i,s.begin()+j+1))){
    			ans=max(ans,j-i+1);
    		}
    	}
    }
