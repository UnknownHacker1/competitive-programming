/*
 * Binary String Minimizing  [1256D]
 * Problem:  https://codeforces.com/problemset/problem/1256/D
 * Verdict:  ACCEPTED        Solved: 2021-06-02
 * Language: C++17 (GCC 7-32)
 * Runtime:  296 ms     Memory: 32600 KB
 * Tags:     greedy
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/1256/submission/118219353
 */
...
tc{
	...
	for(int i = 0; i < n && k > 0 && zeros.size(); i++){
		if(s[i]=='1'){
			auto lb = zeros.lower_bound(i);
			if(lb==zeros.end())
				continue;
			int der = *lb;
			if(k>=der-i){
