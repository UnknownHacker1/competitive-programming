/*
 * Prinzessin der Verurteilung  [1536B]
 ...
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/1536/submission/118630046
 */
...
int main(){
	ACPLS();
	gen("");
	sort(all(generated),[](string a, string b){
		if(a.size()==b.size())
			return a<b;
...
tc{
	...
	for(int i = 0; i < (int)generated.size(); i++){
		if(s.find(generated[i])==string::npos){
			cout<<generated[i]<<'\n';
			break;
		}
	}
