 ...
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/1535/submission/118370722
 */
...
tc{
	int a[4];
	cin>>a[0]>>a[1]>>a[2]>>a[3];
	int winners[2]={max(a[0],a[1]),max(a[2],a[3])};
	sort(winners,winners+2);
	sort(a,a+4);
	if(winners[0]==a[2]&&winners[1]==a[3]){
		cout<<"YES\n";
	}
	else cout<<"NO\n";
}
