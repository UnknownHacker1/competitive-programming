 ...
 * Verdict:  ACCEPTED        Solved: 2021-08-02
 * Language: C++17 (GCC 7-32)
 * Runtime:  311 ms     Memory: 6800 KB
 * Tags:     math, number theory
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/1459/submission/124716927
 */
...
int main()
{
	...
	for(int i = 0; i < m; i++){
		cout<<(g==0?b[i]+a[0]:gcd(g,b[i]+(a[0]%g)) )<<' ';
	}
}