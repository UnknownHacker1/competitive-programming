/*
 * Coin Rows  [1555C]
 * Problem:  https://codeforces.com/problemset/problem/1555/C
 * Verdict:  ACCEPTED        Solved: 2021-07-30
 * Language: C++17 (GCC 9-64)
 * Runtime:  46 ms     Memory: 8100 KB
 * Tags:     brute force, constructive algorithms, dp, implementation
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/1555/submission/124344724
 */
...
tc{
	...
	ll ans=1e18;
	for(int i = 1; i <= n; i++){
		ans=min(ans,max(a[n][1]-a[i][1],a[1][2]-a[i][2]));
	}
	cout<<ans<<'\n';
}
}