/*
 * Two Arrays and Sum of Functions  [1165E]
 * Problem:  https://codeforces.com/problemset/problem/1165/E
 * Verdict:  ACCEPTED        Solved: 2021-08-30
 * Language: C++17 (GCC 7-32)
 * Runtime:  140 ms     Memory: 6800 KB
 * Tags:     greedy, math, sortings
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/1165/submission/127481017
 */
...
int main()
{
	...
	ll ans=0;
	for(int i = 1; i <= n; i++){
		ans+=(a[i]%998244353*b[i]%998244353)%998244353;
		ans%=998244353;
	}
	cout<<ans;
}