/*
 * Yuhao and a Parenthesis  [1097C]
 * Problem:  https://codeforces.com/problemset/problem/1097/C
 * Verdict:  ACCEPTED        Solved: 2021-08-13
 * Language: C++17 (GCC 7-32)
 * Runtime:  46 ms     Memory: 4700 KB
 * Tags:     greedy, implementation
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/1097/submission/125798764
 */
...
int main()
{
	...
	for(int i = 0; i < n; i++){
		...
		if(mn<0&&mn!=cnt)continue;
		if(mn<0&&lrb==-1)continue;
		else if(mn<0)lrb=0;
		if(lrb==-1){
			if(mp[{-cnt,0}]>0){
				--mp[{-cnt,0}];
