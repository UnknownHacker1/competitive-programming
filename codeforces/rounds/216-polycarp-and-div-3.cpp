/*
 * Polycarp and Div 3  [1005D]
 * Problem:  https://codeforces.com/problemset/problem/1005/D
 * Verdict:  ACCEPTED        Solved: 2021-08-05
 * Language: C++17 (GCC 7-32)
 * Runtime:  46 ms     Memory: 19000 KB
 * Tags:     dp, greedy, number theory
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/1005/submission/124994715
 */
...
int rec(int idx,int m){
	...
	ret=max(ret,rec(idx+1,-1)+(curm%3==0));
	ret=max(ret,rec(idx+1,curm));
	return dp[idx][m+1]=ret;
}
int main()
{
	ACPLS();
