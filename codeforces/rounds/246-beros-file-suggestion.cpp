/*
 * BerOS File Suggestion  [1070H]
 * Problem:  https://codeforces.com/problemset/problem/1070/H
 * Verdict:  ACCEPTED        Solved: 2021-06-01
 * Language: C++17 (GCC 7-32)
 * Runtime:  468 ms     Memory: 25400 KB
 * Tags:     brute force, implementation
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/1070/submission/118097468
 */
...
int main() {
	...
	for(int i = 0; i < n; i++){
		...
		for(int j = 0; j < (int)str[i].size(); j++){
			for(int k = 1; k <= (int)str[i].size()-j; k++){
