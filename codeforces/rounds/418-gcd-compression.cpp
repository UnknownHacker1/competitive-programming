/*
 * GCD Compression  [1370B]
 * Problem:  https://codeforces.com/problemset/problem/1370/B
 * Verdict:  ACCEPTED        Solved: 2021-04-28
 * Language: C++17 (GCC 7-32)
 * Runtime:  46 ms     Memory: 100 KB
 * Tags:     constructive algorithms, math, number theory
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/1370/submission/114477446
 */
...
tc{
    ...
    ll a[n];
    for(auto&i:a)cin>>i;
    bool used[(int)1e5+5]={0};
    for(int i = 0; i < n && counter > 0; i++) {
        if(used[i])continue;
        for(int j = 0; j < n && counter > 0; j++) {
