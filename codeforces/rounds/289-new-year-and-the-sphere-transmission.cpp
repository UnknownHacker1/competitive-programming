/*
 * New Year and the Sphere Transmission  [1091C]
 * Problem:  https://codeforces.com/problemset/problem/1091/C
 * Verdict:  ACCEPTED        Solved: 2021-08-23
 * Language: C++17 (GCC 7-32)
 * Runtime:  30 ms     Memory: 3700 KB
 * Tags:     math, number theory
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/1091/submission/126758198
 */
...
int main()
{
	...
	for(ll x = 1; x * x <= n; x++){
		if(n%x==0){
			f.push_back((n/x)*(n/x-1)/2*x+n/x);
			if(x*x!=n){
				ll y=n/x;
				f.push_back((n/y)*(n/y-1)/2*y+n/y);
			}
		}
	}
	sort(all(f));
