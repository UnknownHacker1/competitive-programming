/*
 * Array K-Coloring  [1102B]
 * Problem:  https://codeforces.com/problemset/problem/1102/B
 * Verdict:  ACCEPTED        Solved: 2021-08-07
 * Language: C++17 (GCC 7-32)
 * Runtime:  31 ms     Memory: 4000 KB
 * Tags:     greedy, sortings
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/1102/submission/125164265
 */
...
int main()
{
	...
	for(int i = 1; i <= 5000; i++){
		if(occ[i].size()>k)
			ok=0;
		for(int j=0;j<(int)occ[i].size();j++,lst++,lst%=k){
			ans[occ[i][j]]=lst+1;
		}
	}
	int freq[k+5]={0};
