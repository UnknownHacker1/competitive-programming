 ...
 * Runtime:  62 ms     Memory: 21100 KB
 * Tags:     bitmasks, brute force, divide and conquer, dp, implementation
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/1385/submission/118126615
 */
...
int n;
int str[(int)2e5+2],acc[(int)2e5+2][26]={0};
int rec(int l, int r, int ch){
	if(l>=r)
		return str[l]!=ch;
	int l1=l,r1=(l+r)/2,l2=(l+r)/2+1,r2=r;
	int val1=(r1-l1+1)-(acc[r1][ch]-acc[l1-1][ch]);
	int val2=(r2-l2+1)-(acc[r2][ch]-acc[l2-1][ch]);
	return min(rec(l1,r1,ch+1)+val2,rec(l2,r2,ch+1)+val1);
}
int main(){
	ACPLS();
tc{
