/*
 * The Great Hero  [1480B]
 * Problem:  https://codeforces.com/problemset/problem/1480/B
 * Verdict:  ACCEPTED        Solved: 2021-02-07
 * Language: C++17 (GCC 7-32)
 * Runtime:  139 ms     Memory: 1600 KB
 * Tags:     greedy, implementation, sortings
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/1480/submission/106851578
 */
...
int main()
{
    ...
    while(t--) {
        ...
        bool found = false;
        for(int i = 0; i < n; i++) {
            ll res = ( ( (b[i]/A)+((b[i]%A)>0) ) );
            B-=( a[i]*res );
        }
        if(B+*max_element(a,a+n)>0) cout<<"YES\n";
        else cout<<"NO\n";
    }
}
