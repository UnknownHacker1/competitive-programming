/*
 * RGB Substring (hard version)  [1196D2]
 * Problem:  https://codeforces.com/problemset/problem/1196/D2
 * Verdict:  ACCEPTED        Solved: 2021-07-02
 * Language: GNU C++11
 * Runtime:  265 ms     Memory: 1300 KB
 * Tags:     data structures, dp, implementation, two pointers
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/1196/submission/121124919
 */
...
tc{
    ...
    for(int j = 0; j < 3; j++){
    	...
    	for(int i = 0; i < n; i++){
    		...
    		++trn;
    		trn%=3;
    		if(i+1>=k)ans=min(ans,pref[i]-(i-k<0?0:pref[i-k]));
    	}
    }
    cout<<ans<<'\n';
}
