/*
 * Trailing Loves (or L'oeufs?)  [1114C]
 * Problem:  https://codeforces.com/problemset/problem/1114/C
 * Verdict:  ACCEPTED        Solved: 2021-08-18
 * Language: C++17 (GCC 7-32)
 * Runtime:  31 ms     Memory: 3700 KB
 * Tags:     brute force, implementation, math, number theory
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/1114/submission/126374995
 */
...
int main()
{
	...
	ll ans=1e18;
	for(auto x:prm){
		ans=min(ans,f(n,x)/count(all(prm),x));
	}
	cout<<ans;
}