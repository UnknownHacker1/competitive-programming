/*
 * Strange Function  [1542C]
 * Problem:  https://codeforces.com/problemset/problem/1542/C
 * Verdict:  ACCEPTED        Solved: 2021-07-04
 * Language: GNU C++11
 * Runtime:  46 ms     Memory: 0 KB
 * Tags:     math, number theory
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/1542/submission/121330772
 */
...
tc{
	...
	for(ll i = 1; i <= 50; i++){
		curlcm=lcm(curlcm,i);
		ans+=i*(n-cntdiv(n,curlcm)-cur);
		cur=n-cntdiv(n,curlcm);
	}
	cout<<ans%mod<<'\n';
}
	return 0;
