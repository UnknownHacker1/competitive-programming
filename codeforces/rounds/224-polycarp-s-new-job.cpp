/*
 * Polycarp's New Job  [1101E]
 * Problem:  https://codeforces.com/problemset/problem/1101/E
 * Verdict:  ACCEPTED        Solved: 2021-08-14
 * Language: C++17 (GCC 7-32)
 * Runtime:  358 ms     Memory: 3700 KB
 * Tags:     implementation
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/1101/submission/125882610
 */
...
int main()
{
	...
	while(q--){
		...
		if(ch=='?'){
			...
			int x,y;
			cin>>x>>y;
			mxmx=max(mxmx,max(x,y));
			mxmn=max(mxmn,min(x,y));
		}
	}
}