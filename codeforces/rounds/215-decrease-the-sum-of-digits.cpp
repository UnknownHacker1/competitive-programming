/*
 * Decrease the Sum of Digits  [1409D]
 * Problem:  https://codeforces.com/problemset/problem/1409/D
 * Verdict:  ACCEPTED        Solved: 2021-07-13
 * Language: GNU C++11
 * Runtime:  156 ms     Memory: 3800 KB
 * Tags:     greedy, math
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/1409/submission/122353383
 */
...
tc{
	...
	ll ans=0;
	for(ll i = 0; i < 19; i++){
		ll cd=(n/POWNOM(10,i))%10;
		ll moves=POWNOM(10,i)*((10-cd)%10);
		n+=moves,ans+=moves;
		if(sod(n)<=s){
			cout<<ans<<'\n';
			break;
