/*
 * Sonya and Queries  [713A]
 * Problem:  https://codeforces.com/problemset/problem/713/A
 * Verdict:  ACCEPTED        Solved: 2021-05-03
 * Language: C++17 (GCC 7-32)
 * Runtime:  156 ms     Memory: 7400 KB
 * Tags:     data structures, implementation
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/713/submission/115029664
 */
...
int main() {
    ...
    int q;
    cin>>q;
    map<string,int>freq{};///guaranteed at most 2^18 unique strings
    while(q--){
        char query;
        cin>>query;
        string res;
