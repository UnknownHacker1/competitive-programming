/*
 * And  [1013B]
 * Problem:  https://codeforces.com/problemset/problem/1013/B
 * Verdict:  ACCEPTED        Solved: 2021-04-30
 * Language: C++17 (GCC 7-32)
 * Runtime:  46 ms     Memory: 4100 KB
 * Tags:     greedy
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/1013/submission/114681717
 */
...
int main() {
    ...
    cin>>n>>x;
    vector<ll> a(n),b(n);
    vector<int> freq((int)1e5+5,0);
    vector<vector<int>> pos((int)1e5+5);
    bool yes=0;
    for(int i = 0; i < n; i++)
        cin>>a[i],++freq[a[i]],yes|=(freq[a[i]]>1);
    if(yes){
        cout<<0;
        return 0;
    }
