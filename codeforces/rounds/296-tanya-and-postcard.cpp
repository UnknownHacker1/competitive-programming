/*
 * Tanya and Postcard  [518B]
 * Problem:  https://codeforces.com/problemset/problem/518/B
 * Verdict:  ACCEPTED        Solved: 2021-04-19
 * Language: C++17 (GCC 7-32)
 * Runtime:  31 ms     Memory: 1900 KB
 * Tags:     greedy, implementation, strings
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/518/submission/113488868
 */
...
int main() {
    ...
    string s, t;
    cin>>s>>t;
    int freq[300] = {0},v[(int)(2*1e5+5)]={0};
    int yay = 0, whoops=0;
    for(int i = 0; i < (int)t.length(); i++) freq[t[i]]++;
