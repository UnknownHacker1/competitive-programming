/*
 * Circular Dance  [1095D]
 * Problem:  https://codeforces.com/problemset/problem/1095/D
 * Verdict:  ACCEPTED        Solved: 2021-07-19
 * Language: C++17 (GCC 9-64)
 * Runtime:  109 ms     Memory: 11200 KB
 * Tags:     implementation
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/1095/submission/123060435
 */
...
int main()
{
	...
	for(int j = 1; j <= 2; j++){
		...
		int cnt=2;
		while(cnt<n){
			if(a[vc[cnt-1]][1]==a[vc[cnt-2]][1]||
				a[vc[cnt-1]][1]==a[vc[cnt-2]][2]){
				vc.push_back(a[vc[cnt-1]][1]);
			}
			else if(a[vc[cnt-1]][2]==a[vc[cnt-2]][1]||
				a[vc[cnt-1]][2]==a[vc[cnt-2]][2]){ 
				 vc.push_back(a[vc[cnt-1]][2]);
			}
			else break;
			++cnt;
		}
