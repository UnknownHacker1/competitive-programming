/*
 * Killjoy  [1419C]
 * Problem:  https://codeforces.com/problemset/problem/1419/C
 * Verdict:  ACCEPTED        Solved: 2021-05-29
 * Language: C++17 (GCC 7-32)
 * Runtime:  46 ms     Memory: 0 KB
 * Tags:     greedy, implementation, math
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/1419/submission/117785982
 */
...
tc{
	...
	bool ok=1;
	int check=0;
	for(auto&i:a)cin>>i,ok&=(i==x),check+=(x-i);
	cout<<(ok==1?0:(check==0||count(a,a+n,x)>=1)?1:2)<<'\n';
}
}
