/*
 * Xenia and Spies  [342B]
 * Problem:  https://codeforces.com/problemset/problem/342/B
 * Verdict:  ACCEPTED        Solved: 2021-06-20
 * Language: C++17 (GCC 7-32)
 * Runtime:  93 ms     Memory: 7700 KB
 * Tags:     brute force, greedy, implementation
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/342/submission/120140479
 */
...
int main()
{
    ...
    for(int i = 1; i <= 1e6 && s!=f; i++){
    	auto&p=t[i];
    	if((s>=p.first&&s<=p.second)||
    	   (s+dir>=p.first&&s+dir<=p.second)){
    		cout<<'X';
    	}
    	else{
    		s+=dir;
