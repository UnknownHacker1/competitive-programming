/*
 * One Bomb  [699B]
 * Problem:  https://codeforces.com/problemset/problem/699/B
 * Verdict:  ACCEPTED        Solved: 2021-05-14
 * Language: C++17 (GCC 7-32)
 * Runtime:  46 ms     Memory: 3900 KB
 * Tags:     implementation
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/699/submission/116204637
 */
...
int main() {
	...
	int n,m;
	cin>>n>>m;
	int st1[n]={0},st2[m]={0},grid[n][m],tot=0;
	for(int i = 0; i < n; i++){
		for(int j = 0; j < m; j++){
			char ch;
			cin>>ch;
