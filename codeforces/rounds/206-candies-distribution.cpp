/*
 * Candies Distribution  [1054C]
 * Problem:  https://codeforces.com/problemset/problem/1054/C
 * Verdict:  ACCEPTED        Solved: 2021-08-08
 * Language: C++17 (GCC 7-32)
 * Runtime:  31 ms     Memory: 3900 KB
 * Tags:     constructive algorithms, implementation
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/1054/submission/125226537
 */
...
int main()
{
	...
	vector<int>occ[2*n+3];
	for(auto&i:l)cin>>i;
	for(auto&i:r)cin>>i;
	for(int i = 0; i < n; i++){
		occ[l[i]+r[i]].push_back(i);
	}
	int cur=1;
	for(int i = n-1; i >= 0; i--){
		if(occ[i].empty())
