/*
 * Stas and the Queue at the Buffet  [1151D]
 * Problem:  https://codeforces.com/problemset/problem/1151/D
 * Verdict:  ACCEPTED        Solved: 2021-09-06
 * Language: C++17 (GCC 7-32)
 * Runtime:  108 ms     Memory: 5200 KB
 * Tags:     greedy, math, sortings
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/1151/submission/128080668
 */
...
int main()
{
	...
	sort(ab,ab+n,[](pair<ll,ll>p1,pair<ll,ll>p2){
		return p1.first-p1.second>p2.first-p2.second;
	});
	ll ans=0;
	for(int i = 0; i < n; i++){
		ans+=ab[i].first*i+ab[i].second*(n-i-1);
	}
	cout<<ans;
}
