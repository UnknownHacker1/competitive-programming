/*
 * Permutation Cycle  [932C]
 * Problem:  https://codeforces.com/problemset/problem/932/C
 * Verdict:  ACCEPTED        Solved: 2021-07-27
 * Language: C++17 (GCC 9-64)
 * Runtime:  140 ms     Memory: 11400 KB
 * Tags:     brute force, constructive algorithms
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/932/submission/123951638
 */
...
int main()
{
	...
	vector<int>ans;
	int i;
	for(i = 1; i+a <= n+1 && cnt%b!=0; i+=a,cnt-=a){
		if(a==1){
			ans.push_back(i);
			continue;
		}
