/*
 * A Tale of Two Lands  [1166C]
 * Problem:  https://codeforces.com/problemset/problem/1166/C
 * Verdict:  ACCEPTED        Solved: 2021-07-12
 * Language: GNU C++11
 * Runtime:  140 ms     Memory: 5400 KB
 * Tags:     binary search, sortings, two pointers
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/1166/submission/122256224
 */
...
int main()
{
	...
	sort(a+1,a+n+1);
	for(int i = 1; i <= n; i++){
		ans+=upper_bound(a+1,a+n+1,2*a[i])-a-i-1;
	}
	cout<<ans;
	return 0;
}