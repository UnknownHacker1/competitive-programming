/*
 * Make It Equal  [1065C]
 * Problem:  https://codeforces.com/problemset/problem/1065/C
 * Verdict:  ACCEPTED        Solved: 2021-08-29
 * Language: C++17 (GCC 7-32)
 * Runtime:  78 ms     Memory: 9900 KB
 * Tags:     greedy
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/1065/submission/127328466
 */
...
int main()
{
	...
	ll x=0,cnt=0,ans=1;
	ll lol[mx-mn+5]={0},lol2[mx-mn+5]={0};
	for(ll i = mx,j=1; i >= mn+1; i--,j++){
		cnt+=freq[i];
		x+=cnt;
		lol2[j]=x;
		lol[j]=x-lol2[j-1];
