/*
 * Obtain The String  [1295C]
 * Problem:  https://codeforces.com/problemset/problem/1295/C
 * Verdict:  ACCEPTED        Solved: 2021-09-08
 * Language: C++17 (GCC 7-32)
 * Runtime:  31 ms     Memory: 5100 KB
 * Tags:     dp, greedy, strings
 * Author:   BidoTeima
 * Source:   https://codeforces.com/contest/1295/submission/128297639
 */
...
tc{
	...
	for(int i = 0; i < (int)t.size(); i++){
		...
		auto it = upper_bound(all(occ[t[i]]),prev);
		if(it==occ[t[i]].end()){
			++ans;
			prev=occ[t[i]].front();
		}
